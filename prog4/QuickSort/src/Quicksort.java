 ...
 * work with other data types e.g. string i.e. generate random text of size 10+ characters and then sort it using quicksort
 */
 ...
 */
    ...
    /* Positions the pivot element at its correct position in sorted array and returns the pivot element index */
